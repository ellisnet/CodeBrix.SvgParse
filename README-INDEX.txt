================================================================================
README-INDEX: CodeBrix.SvgParse
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.SvgParse.MsplLicenseForever -- renderer-agnostic SVG document
      object model: parse, query, style, modify and re-serialize SVG.
