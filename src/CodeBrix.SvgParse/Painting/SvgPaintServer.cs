...
{
    /// <summary>Gets or sets the GetCallback.</summary>
    ...
    /// </summary>
    public static readonly SvgPaintServer Inherit = new SvgColorServer();

    /// <summary>
    /// An unspecified <see cref="SvgPaintServer"/>.
    /// </summary>
    public static readonly SvgPaintServer NotSet = new SvgColorServer();
