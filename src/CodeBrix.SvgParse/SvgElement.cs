...
public abstract partial class SvgElement : ISvgElement, ISvgTransformable, ICloneable, ISvgNode
{
    ...
    /// <summary>Gets or sets the ContainsAttribute(string).</summary>
    ...
    /// <summary>Gets or sets the TryGetAttribute(string, out string).</summary>
    /// <summary>Attempts to perform the TryGetAttribute(string, out string) operation.</summary>
    ...
    /// <summary>Gets or sets the HttpClient.</summary>
    ...
    /// <summary>Performs the Nodes operation.</summary>
    ...
    /// <summary>Performs the Parents operation.</summary>
    ...
    /// <summary>Gets or sets the ParentsAndSelf.</summary>
    /// <summary>Performs the ParentsAndSelf operation.</summary>
    ...
    /// <summary>Gets or sets the Writing.</summary>
    protected bool Writing { get; set; }

    /// <summary>Gets or sets the GetAttribute.</summary>
    ...
    /// <summary>Gets or sets the SetAndForceUniqueID(string, bool, Action.</summary>
    /// <summary>Sets the AndForceUniqueID(string, bool, Action.</summary>
    ...
    /// <summary>Performs the InitialiseFromXML(XmlReader, SvgDocument) operation.</summary>
    ...
    /// <summary>Gets or sets the WriteStartElement(XmlWriter).</summary>
    ...
    /// <summary>Gets or sets the WriteEndElement(XmlWriter).</summary>
    ...
    /// <summary>Gets or sets the WriteAttributes(XmlWriter).</summary>
            ...
            foreach (var property in this.GetProperties())
            {
                ...
                if (property.Converter.CanConvertTo(typeof(string)))
                {
                    ...
                    if (Attributes.ContainsKey(property.AttributeName))
                    {
                        ...
                        if (hasOpacity)
                        {
                            if (propertyValue is SvgColorServer && ((SvgColorServer)propertyValue).ColorValue.A < 255)
                            {
                                var opacity = ((SvgColorServer)propertyValue).ColorValue.A / 255f;
    ...
    /// <summary>Gets or sets the AutoPublishEvents.</summary>
    ...
    /// <summary>Performs the DeepCopy() operation.</summary>
    ...
    /// <summary>Gets or sets the OnAttributeChanged(AttributeEventArgs).</summary>
    ...
    /// <summary>Gets or sets the OnContentChanged(ContentEventArgs).</summary>
    ...
    /// <summary>Gets or sets the Click.</summary>
    /// <summary>Occurs when the Click event is raised.</summary>
    [SvgAttribute("onclick")]
    public event EventHandler<MouseArg> Click;

    /// <summary>Gets or sets the MouseDown.</summary>
    /// <summary>Occurs when the MouseDown event is raised.</summary>
    [SvgAttribute("onmousedown")]
    public event EventHandler<MouseArg> MouseDown;

    /// <summary>Gets or sets the MouseUp.</summary>
    /// <summary>Occurs when the MouseUp event is raised.</summary>
    [SvgAttribute("onmouseup")]
    public event EventHandler<MouseArg> MouseUp;

    /// <summary>Gets or sets the MouseMove.</summary>
    /// <summary>Occurs when the MouseMove event is raised.</summary>
    [SvgAttribute("onmousemove")]
    public event EventHandler<MouseArg> MouseMove;

    /// <summary>Gets or sets the MouseScroll.</summary>
    /// <summary>Occurs when the MouseScroll event is raised.</summary>
    [SvgAttribute("onmousescroll")]
    public event EventHandler<MouseScrollArg> MouseScroll;

    /// <summary>Gets or sets the MouseOver.</summary>
    /// <summary>Occurs when the MouseOver event is raised.</summary>
    [SvgAttribute("onmouseover")]
    public event EventHandler<MouseArg> MouseOver;

    /// <summary>Gets or sets the MouseOut.</summary>
    /// <summary>Occurs when the MouseOut event is raised.</summary>
    [SvgAttribute("onmouseout")]
    public event EventHandler<MouseArg> MouseOut;

    /// <summary>Gets or sets the CreateMouseEventAction(Action.</summary>
    ...
    //click
    /// <summary>Gets or sets the RaiseMouseClick(object, MouseArg).</summary>
    ...
    //down
    /// <summary>Gets or sets the RaiseMouseDown(object, MouseArg).</summary>
    ...
    //up
    /// <summary>Gets or sets the RaiseMouseUp(object, MouseArg).</summary>
    ...
    /// <summary>Gets or sets the RaiseMouseMove(object, MouseArg).</summary>
    ...
    //over
    /// <summary>Gets or sets the RaiseMouseOver(object, MouseArg).</summary>
    ...
    //out
    /// <summary>Gets or sets the RaiseMouseOut(object, MouseArg).</summary>
    ...
    //scroll
    /// <summary>Gets or sets the OnMouseScroll(int, bool, bool, bool, string).</summary>
    ...
    /// <summary>Gets or sets the RaiseMouseScroll(object, MouseScrollArg).</summary>
...
/// <summary>Gets or sets the SVGArg.</summary>
/// <summary>Represents the <see cref="SVGArg"/> class.</summary>
...
{
    /// <summary>Gets or sets the NewChild.</summary>
    public SvgElement NewChild;
    /// <summary>Gets or sets the BeforeSibling.</summary>
    public SvgElement BeforeSibling;
}

//deriving class registers event actions and calls the actions if the event occurs
/// <summary>Gets or sets the ISvgEventCaller.</summary>
/// <summary>Defines the <see cref="ISvgEventCaller"/> interface.</summary>
public interface ISvgEventCaller
{
    /// <summary>Gets or sets the RegisterAction(string, Action).</summary>
    void RegisterAction(string rpcID, Action action);
    /// <summary>Gets or sets the RegisterAction.</summary>
    ...
    /// <summary>Gets or sets the UnregisterAction(string).</summary>
...
/// <summary>Gets or sets the MouseScrollArg.</summary>
/// <summary>Represents the <see cref="MouseScrollArg"/> class.</summary>
public class MouseScrollArg : SVGArg
{
    /// <summary>Gets or sets the Scroll.</summary>
    public int Scroll;
...
/// <summary>Gets or sets the ISvgNode.</summary>
/// <summary>Defines the <see cref="ISvgNode"/> interface.</summary>
