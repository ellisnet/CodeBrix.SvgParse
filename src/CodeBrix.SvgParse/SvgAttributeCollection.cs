...
public sealed class SvgAttributeCollection : Dictionary<string, object>
{
    ...
    /// <summary>Gets or sets the SvgAttributeCollection(SvgElement).</summary>
    /// <summary>Initializes a new instance of the <see cref="SvgAttributeCollection"/> class with the specified parameters.</summary>
    ...
    /// <summary>Gets or sets the GetInheritedAttribute.</summary>
    /// <summary>Gets the InheritedAttribute.</summary>
    ...
    /// <summary>Gets or sets the AttributeChanged.</summary>
    /// <summary>Occurs when the AttributeChanged event is raised.</summary>
...
/// <summary>Gets or sets the SvgCustomAttributeCollection.</summary>
/// <summary>Represents the <see cref="SvgCustomAttributeCollection"/> class.</summary>
public sealed class SvgCustomAttributeCollection : Dictionary<string, string>
{
    private readonly SvgElement _owner;

    /// <summary>Gets or sets the SvgCustomAttributeCollection(SvgElement).</summary>
    /// <summary>Initializes a new instance of the <see cref="SvgCustomAttributeCollection"/> class with the specified parameters.</summary>
