...
public partial struct SvgViewBox
{
    ...
    /// <summary>
    /// Performs an implicit conversion from <see cref="SvgViewBox"/> to <see cref="SvgRectangleF"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    public static implicit operator SvgRectangleF(SvgViewBox value)
    {
        return new SvgRectangleF(value.MinX, value.MinY, value.Width, value.Height);
    }

    /// <summary>
    /// Performs an implicit conversion from <see cref="SvgRectangleF"/> to <see cref="SvgViewBox"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    public static implicit operator SvgViewBox(SvgRectangleF value)
    {
    ...
    /// <summary>Gets or sets the Equals(SvgViewBox).</summary>
    /// <summary>Performs the Equals(SvgViewBox) operation.</summary>
    ...
    /// <summary>Gets or sets the operator ==(SvgViewBox, SvgViewBox).</summary>
