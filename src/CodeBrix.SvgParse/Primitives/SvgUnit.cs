...
public partial struct SvgUnit
{
    ...
    /// <summary>Gets or sets the Equals(SvgUnit).</summary>
    /// <summary>Performs the Equals(SvgUnit) operation.</summary>
    ...
    /// <summary>Gets or sets the operator ==(SvgUnit, SvgUnit).</summary>
...
/// <summary>Gets or sets the UnitRenderingType.</summary>
/// <summary>Defines the UnitRenderingType enumeration.</summary>
public enum UnitRenderingType
{
    /// <summary>Gets or sets the Other.</summary>
    /// <summary>The Other value.</summary>
    Other,
    /// <summary>Gets or sets the Horizontal.</summary>
    /// <summary>The Horizontal value.</summary>
    Horizontal,
    /// <summary>Gets or sets the HorizontalOffset.</summary>
    /// <summary>The HorizontalOffset value.</summary>
    HorizontalOffset,
    /// <summary>Gets or sets the Vertical.</summary>
    /// <summary>The Vertical value.</summary>
    Vertical,
    /// <summary>Gets or sets the VerticalOffset.</summary>
    /// <summary>The VerticalOffset value.</summary>
    VerticalOffset
}
