...
public partial class SvgElement
{
    ...
    /// <summary>Gets or sets the FixOpacityValue(float).</summary>
    ...
    public SvgColorInterpolation ColorInterpolation
    {
        get { return GetAttribute("color-interpolation", true, SvgColorInterpolation.SRGB); }
    ...
    public SvgColorInterpolation ColorInterpolationFilters
    {
        get { return GetAttribute("color-interpolation-filters", true, SvgColorInterpolation.LinearRGB); }
