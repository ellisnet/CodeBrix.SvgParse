...
/// <summary>Gets or sets the SvgTextBase.</summary>
/// <summary>Represents the <see cref="SvgTextBase"/> class.</summary>
public abstract partial class SvgTextBase : SvgVisualElement
{
    ...
    /// <summary>Gets or sets the SvgTextBase().</summary>
    /// <summary>Initializes a new instance of the <see cref="SvgTextBase"/> class.</summary>
    public SvgTextBase()
    {
    ...
    /// <summary>Gets or sets the SpaceHandling.</summary>
    ...
    {
        get { return GetAttribute<SvgPaintServer>("fill", true, new SvgColorServer(SvgColor.Black)); }
    ...
    /// <summary>Gets or sets the RegisterEvents(ISvgEventCaller).</summary>
    /// <inheritdoc />
    ...
    /// <summary>Gets or sets the UnregisterEvents(ISvgEventCaller).</summary>
    /// <inheritdoc />
