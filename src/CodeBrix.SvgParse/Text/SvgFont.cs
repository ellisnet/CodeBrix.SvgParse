...
/// <summary>Gets or sets the SvgFont.</summary>
/// <summary>Represents the <see cref="SvgFont"/> class.</summary>
[SvgElement("font")]
public partial class SvgFont : SvgElement
{
    ...
    /// <summary>Gets or sets the HorizOriginX.</summary>
    ...
    /// <summary>Gets or sets the HorizOriginY.</summary>
