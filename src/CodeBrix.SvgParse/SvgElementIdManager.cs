...
public class SvgElementIdManager
{
    ...
    /// <summary>Gets or sets the GetElementById(Uri).</summary>
    /// <summary>Gets the ElementById(Uri).</summary>
    ...
    /// <summary>Gets or sets the ElementAdded.</summary>
    /// <summary>Occurs when the ElementAdded event is raised.</summary>
    public event EventHandler<SvgElementEventArgs> ElementAdded;
    /// <summary>Gets or sets the ElementRemoved.</summary>
    /// <summary>Occurs when the ElementRemoved event is raised.</summary>
    public event EventHandler<SvgElementEventArgs> ElementRemoved;

    /// <summary>Gets or sets the OnAdded(SvgElement).</summary>
    ...
    /// <summary>Gets or sets the OnRemoved(SvgElement).</summary>
...
/// <summary>Gets or sets the SvgElementEventArgs.</summary>
/// <summary>Represents the <see cref="SvgElementEventArgs"/> class.</summary>
